...
This README describes the v1.3.0 feature set. The release badge above and the [latest-release page](https://github.com/aidamian/PurpleRay_SBOM_Analyzer/releases/latest) identify the newest release actually published on GitHub, independently of the version documented here.
